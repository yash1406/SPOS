...
public class MacroP1 {
	...
	public static void main(String[] args) throws IOException{
		...
		File mntR = new File("mnt.txt");
		File pntR = new File("pntab.txt");
		File kpdtR = new File("kpdt.txt");
		File mdtR = new File("mdt.txt");
		
		System.out.println("\tMNT");
		Scanner sc = new Scanner(mntR);
