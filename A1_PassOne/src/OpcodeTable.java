...
public class OpcodeTable {
	...
	public OpcodeTable() {
		...
		OPTAB.put("LT", new OpcodeEntry("CC", 1));
		OPTAB.put("LE", new OpcodeEntry("CC", 2));
		OPTAB.put("EQ", new OpcodeEntry("CC", 3));
		OPTAB.put("GT", new OpcodeEntry("CC", 4));
		OPTAB.put("GE", new OpcodeEntry("CC", 5));
		OPTAB.put("ANY", new OpcodeEntry("CC", 6));
	}	
